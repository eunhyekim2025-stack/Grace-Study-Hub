...
<div class="dc-view"><div class="dc-title">Integrated Quiz — Law × Decision Analysis × Financial Accounting</div><div class="dc-sub">Three-subject composite scenario analysis</div><div class="dc-flow"><div class="dc-step"><div class="dc-step-n">1</div><div class="dc-step-t">Analyze the business case</div><div class="dc-step-d">Through three lenses: Law, Decision Analysis, Financial Accounting</div></div><div class="dc-arrow">→</div><div class="dc-step"><div class="dc-step-n">2</div><div class="dc-step-t">Apply relevant concepts</div><div class="dc-step-d">IRAC for Law, Issue/Method/Application/Conclusion for DA and FA</div></div></div><div class="dc-section"><span class="dc-num">1</span><h2>Contract Law</h2><span class="dc-hint">Offer, acceptance, and enforceability</span></div><div class="dc-card"><b>Offer</b> must be clear, definite, and communicated, with an intention to be bound <span class="dc-chip">IRAC</span></div><div class="dc-card"><b>Acceptance</b> must be a mirror-image match to the offer <span class="dc-chip">Contract formation</span></div><div class="dc-section"><span class="dc-num">2</span><h2>Financial Accounting</h2><span class="dc-hint">Inventory, freight, and purchase discounts</span></div><div class="dc-card"><b>FOB Shipping Point</b> inventory recognized at shipment, freight added to cost, discount deducted <span class="dc-chip">Inventory valuation</span></div><div class="dc-card"><b>Purchase discount</b> deducted from inventory cost <span class="dc-chip">Purchase accounting</span></div><div class="dc-section"><span class="dc-num">3</span><h2>Decision Analysis</h2><span class="dc-hint">Demand simulation and expected value</span></div><div class="dc-card"><b>Normal distribution</b> used for demand simulation <span class="dc-chip">Simulation</span></div><div class="dc-card"><b>Expected value</b> calculated using probabilities and outcomes <span class="dc-chip">Expected value calculation</span></div><div class="dc-callout">The most important rule: <b>specificity + intention to be bound</b> determines the boundary line between an offer and an invitation to treat</div></div>
