...
<div class="dc-view">
<div><div class="dc-title">Basic Concepts of Reasoning</div><div class="dc-sub">The vocabulary the whole course is built on — argument, inference, and the two ways an argument can be good</div></div>
<div class="dc-flow">
<div class="dc-step"><div class="dc-step-n">1</div><div class="dc-step-t">Statement?</div><div class="dc-step-d">has a truth value (T/F)</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">2</div><div class="dc-step-t">Argument?</div><div class="dc-step-d">reasons → conclusion via an inference</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">3</div><div class="dc-step-t">Deduction or induction?</div><div class="dc-step-d">certainty vs probability</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">4</div><div class="dc-step-t">Good?</div><div class="dc-step-d">true premises + acceptable inference</div></div>
</div>
<div class="dc-section"><span class="dc-num">★</span><h2>The one idea to hold onto</h2><span class="dc-hint">two independent questions</span></div>
<div class="dc-cols">
<div class="dc-card"><div class="dc-eyebrow">Are the premises true?</div>A question about the <b>world</b> — answered by evidence, research, testimony, definitions.</div>
<div class="dc-card"><div class="dc-eyebrow">Is the inference acceptable?</div>A question about the <b>link</b> — would the premises, <i>if</i> true, support the conclusion? Answered without checking whether they're actually true.</div>
</div>
<div class="dc-callout">These two are <b>entirely independent</b>. An argument can have false premises + a perfect inference, or true premises + a broken inference. Never let one answer stand in for the other — this separation is the spine of the entire book.</div>
</div>
...
```mermaid
flowchart TD
  A[A claim is made] --> B{Reasons given?}
  B -- No --> Z[Just an opinion — not reasoning]
  B -- Yes --> C{Aiming at certainty or probability?}
  C -- certainty --> D{Valid?}
  D -- No --> U1[Invalid → Unsound]
  D -- Yes --> E{All premises true?}
  E -- No --> U2[Unsound]
  E -- Yes --> S[SOUND ✓]
  C -- probability --> F{Strong?}
  F -- No --> U3[Uncogent]
  F -- Yes --> G{All premises true?}
  G -- No --> U4[Uncogent]
  G -- Yes --> H{Reliable? premises omit no lowering info}
  H -- No --> U5[Uncogent]
  H -- Yes --> K[COGENT ✓ — conclusion probably true]
```
