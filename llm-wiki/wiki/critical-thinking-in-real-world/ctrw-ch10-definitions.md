...
<div class="dc-view">
<div><div class="dc-title">Definitions</div><div class="dc-sub">Agree on the key terms first — most "disagreements" are two people talking past each other</div></div>
<div class="dc-flow">
<div class="dc-step"><div class="dc-step-n">1</div><div class="dc-step-t">Why define</div><div class="dc-step-d">stop talking past each other</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">2</div><div class="dc-step-t">6 criteria</div><div class="dc-step-d">what makes a definition good</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">3</div><div class="dc-step-t">Unclarity</div><div class="dc-step-d">ambiguity vs vagueness</div></div>
<div class="dc-arrow">→</div>
<div class="dc-step"><div class="dc-step-n">4</div><div class="dc-step-t">Methods</div><div class="dc-step-d">ostensive · genus-difference · nec/suff</div></div>
</div>
<div class="dc-section"><span class="dc-num">★</span><h2>The anatomy of a definition</h2><span class="dc-hint">two sides of an equivalence</span></div>
<div class="dc-cols-2">
<div class="dc-card"><div class="dc-eyebrow">Definiendum</div>the term <b>being defined</b> (left-hand side) — e.g. "Ice".</div>
<div class="dc-card"><div class="dc-eyebrow">Definiens</div>the phrase that <b>gives</b> the definition (right-hand side) — e.g. "frozen water".</div>
</div>
<div class="dc-callout"><b>Dictionaries are useful, not infallible.</b> They *report* how a community uses a word; they don't *fix* meaning (words are often vague, experts disagree, meanings drift). Treating a dictionary as the final authority is a mild [[ctrw-ch07-fallacies|appeal to authority]].</div>
</div>
...
## Six criteria of a good definition
A definition should be:

| # | Criterion | Fails when… |
|---|---|---|
| 1 | **Clear** | grammar is broken, it's metaphorical, uses obscure terms, or is ambiguous |
| 2 | **Precise within reasonable limits** | it's vague (borderline cases it can't decide) |
| 3 | **Not too broad** | the definiens lets in things that *aren't* the definiendum ("a typewriter is a means of writing" — so are pens) |
| 4 | **Not too narrow** | the definiens excludes things that *are* the definiendum ("a bird is a feathered animal capable of flight" — excludes penguins) |
| 5 | **Non-circular** | the term reappears in the definiens ("a cordless phone is a phone with no cord") |
| 6 | **Not unfairly emotive** | it smuggles in a verdict via loaded words ("abortion is the *wanton murder* of…") |
...
3. **Obscure terms** in the definiens — fine only if the audience knows them ("a grampus is a … cetacean").
4. **Ambiguity** — a word/phrase/structure with two meanings ("Budweiser is a **light** beer" — colour? taste? alcohol?).

## Ambiguity vs vagueness (don't confuse them)
...
## Why this matters for argument
- In a real dispute (the book runs the **abortion** debate throughout), the whole thing often turns on a **key term** — "foetus," "human being," "innocent." Whoever's definition is accepted may **win the argument for free**.
- So: **make your opponent's loaded or question-begging definition explicit and challenge it** ("abortion is *murder*" **begs the question** that the foetus is a person). Insist on a **neutral** definition both sides can share ("abortion is the deliberate killing of a foetus") — then the real issue (is it *wrong*?) is left open for actual argument.
...
- [[case-drug-legalisation-grayling]] — a real op-ed where the load-bearing move is how "self-regarding" is defined
