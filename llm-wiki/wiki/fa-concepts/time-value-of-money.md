...
> This concept is used directly in computing the issue price in [[fa-concepts/bonds-payable]].
...
| Bond issue price = PV of principal + PVA of coupons | Both ([[fa-concepts/bonds-payable]]) |
...
- [[fa-concepts/bonds-payable]] ← bond issue price = PV(principal) + PVA(coupons)
