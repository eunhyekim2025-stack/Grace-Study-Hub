...
> Graph views: [[graph-dashboard]] (metrics·inference·loops) · [[graph-viz]] (Mermaid focus view) · `graph/graph.html` (interactive full graph)
> Overview: [[overview]] — purpose and structure of this wiki
