...
<a class="sh-card" href="./critical-thinking-in-real-world"><span class="sh-card-dot" style="--sh-dot: oklch(0.62 0.15 20)"></span><span class="sh-card-title">📓 Critical Thinking in Real World</span><span class="sh-card-desc">Textbook (11 ch) · Real-world cases <span class="sh-card-count">12</span></span></a>
