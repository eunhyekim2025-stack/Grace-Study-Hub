...
<a class="sh-card" href="./sql"><span class="sh-card-dot" style="--sh-dot: oklch(0.62 0.15 210)"></span><span class="sh-card-title">🗄 SQL</span><span class="sh-card-desc">혼자 공부하는 SQL + SQLBolt — 노트 9</span></a>
<!-- add-subject-cards -->
</div>
