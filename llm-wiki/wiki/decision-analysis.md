...
> [[index|← Subjects]] · Anderson/Sweeney/Williams *Management Science* 14e — **Content → Quizzes → Sources**

## Content — Concepts (da-concepts/)
> Full-textbook atomic notes (LP · sensitivity · networks · integer · nonlinear · PERT · inventory · decision analysis · forecasting · simulation), organized by cluster. See the 🗺️ MOC for the full map.
...
| Source | Description |
|--------|-------------|
| `raw/da/Textbook.pdf` | Anderson/Sweeney/Williams, *An Introduction to Management Science* 14e |
| `raw/da/textbook-solutions/MS14E_chapter_NN_*` | Ch.1–21 exercise solutions (Ch.12 = simulation) |
| `raw/da/excel-solutions/*.xlsx` | LP/simulation Excel solutions (Blending, Media Selection, Portfolio, etc.) |
| `raw/da/homework/` | Homework 1–3 problems and answers |
