...
*2026-06-24 생성 · 전체 인터랙티브: `graph/graph.html`*
...
flowchart LR
  ...
  n_law_concepts_mistake["mistake"]
  ...
  n_cases_chwee_kin_keong_v_digilandmall -->|about| n_law_concepts_mistake
...
```mermaid
flowchart LR
  n_law_concepts_undue_influence["undue-influence"]
  n_law_concepts_vitiating_factor["vitiating-factor ·의미"]
  n_law_concepts_duress["duress"]
  n_law_concepts_misrepresentation["misrepresentation"]
  n_law_concepts_undue_influence -->|is-a| n_law_concepts_vitiating_factor
  n_law_concepts_duress -->|is-a| n_law_concepts_vitiating_factor
  n_law_concepts_misrepresentation -->|is-a| n_law_concepts_vitiating_factor
```
