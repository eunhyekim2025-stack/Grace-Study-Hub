...
See [[wiki/statutes/contracts-rights-third-parties-act]]. Cases where a third party may enforce a contract:
- **s.2(1)(a)**: the contract expressly confers a right of enforcement on the third party
- **s.2(1)(b)**: a term of the contract purports to confer a benefit on the third party (unless it appears the parties did not so intend — s.2(2))
- The third party need only be identified by name, class or description (s.2(3))

## Common Law exceptions (predating the CRTPA)
...
| **Himalaya clause** | Extends an exemption to stevedores etc. under a carriage contract | *The Eurymedon [1975]* |
| Restrictive covenant over land | *Tulk v Moxhay [1848]* | — |
