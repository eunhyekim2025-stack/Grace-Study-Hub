...
Distribution of profit to shareholders. A sub-topic of [[fa-concepts/shareholders-equity]]; when cash goes out, it is shown under financing activities (FCF) in the [[fa-concepts/statement-of-cash-flows]].
...
- [[fa-concepts/shareholders-equity]] ← shares, APIC, treasury shares
- [[fa-concepts/statement-of-cash-flows]] ← cash dividend payments are financing (FCF) outflows
